package com.daniel.gd13_a_0544
...
class AddEditActivityTest1 {
    ...
    fun addEditActivityTest1() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Daniel"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710544"), closeSoftKeyboard())
